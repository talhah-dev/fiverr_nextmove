...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        // Container defines the height; content is centered inside it
        'relative flex min-h-[60vh] md:min-h-[80vh] lg:min-h-screen w-full items-center justify-center overflow-hidden bg-black',
        className
      )}
    >
      {/* Lamp background – completely separated from layout & hover */}
      ...
      {/* Content – now completely stable, no translate-y hacks */}
...
// Keep original LampEffect for backwards compatibility (unchanged)
